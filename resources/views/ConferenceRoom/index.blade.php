...
@section('content')
                    ...
                    <div class="top-option">
                        ...
                        <div id="News" class="tabcontent" style="display:none">
                            ...
                            <div class="message">
                                ...
                                <input value="{{session('idRoom')}}" hidden id="idRoom-chat">
    ...
    <div class="listCam">
        <div class="camlocal" id="localStream"></div>
        <div class="camremote" id="remoteStream"></div>
    </div>

    <input value="{{session('idRoom')}}.{{session('avatar')}}" hidden id="idRoom">
    <input value="{{session('name')}}.{{session('id')}}" hidden id="idUser">
